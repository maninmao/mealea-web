...
exports.createCheckoutSession = async (userId, userEmail) => {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        mode:                 'payment',
        success_url: `${process.env.CLIENT_URL}/client/pages/order-success.html?session_id={CHECKOUT_SESSION_ID}`,
        cancel_url:  `${process.env.CLIENT_URL}/client/pages/cart.html`,
    });
